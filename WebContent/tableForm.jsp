			...
			<div class="menu-sidebar__content js-scrollbar1">
				<nav class="navbar-sidebar">
					<ul class="list-unstyled navbar__list">
						<li class="active"><a href="tableForm.jsp"> <i
								class="fas fa-table"></i> 生成题目
						</a></li>
						<li><a href="chartForm.jsp"> <i class="fas fa-chart-bar"></i>答案校验
						</a></li>
					</ul>
							...
							<div class="col-lg-6">
								<div class="card">
									<div class="card-header">
										<strong>题目参数</strong> 列表
									</div>
									<div class="card-body card-block">
										<form action="exam" method="post" class="form-horizontal">
											<div class="row form-group">
												<div class="col col-md-3">
													<label for="hf-email" class=" form-control-label">题目数量</label>
												</div>
												<div class="col-12 col-md-9">
													<input type="text" id="examNum" name="examNum"
														placeholder="请输入题目数量" class="form-control">
												</div>
											</div>
											<div class="row form-group">
												<div class="col col-md-3">
													<label for="hf-password" class=" form-control-label">题目最大值</label>
												</div>
												<div class="col-12 col-md-9">
													<input type="text" id="maxNum" name="maxNum"
														placeholder="范围为0~你的输入" class="form-control">
												</div>
											</div>

											<button type="submit" class="btn btn-primary btn-sm">
												<i class="fa fa-dot-circle-o"></i> 生成题目
											</button>
											<button type="reset" class="btn btn-danger btn-sm">
												<i class="fa fa-ban"></i> 重新输入
											</button>
										</form>
									</div>
								</div>
